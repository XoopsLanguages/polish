...
define('_WEBSITE_NAME', 'XOOPS Witryna');
define('_WEBSITE_SLOGAN', 'Po prostu użyj tego!');
define('_WEBSITE_META_KEYWORDS', 'xoops, framework aplikacji internetowych, cms, system zarządzania treścią');
define('_WEBSITE_FOOTER', "Powered by XOOPS © 2001-{X_YEAR} <a href='https://xoops.org' rel='external' title='The XOOPS Project'>Projekt XOOPS</a>");
define('_WEBSITE_COPYRIGHT', 'Prawa autorskie © 2001-{X_YEAR}');
define('_WEBSITE_DESCRIPTION', 'XOOPS to dynamiczny skrypt portalu typu open source, oparty na obiektowości, napisany w PHP.');
