 ...
 */
// Navigation
define('_AM_SYSTEM_MODULES_ADMIN', 'Powrót do administracji modułami');
...
define('_AM_SYSTEM_MODULES_LISTUPBLKS', 'Następujące bloki zostaną zaktualizowane.<br>Wybierz bloki, których zawartość (szablon i opcje) może zostać nadpisana.<br>');
...
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD', 'Dodano prawa użytkownika dla grupy o ID: %s');
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD_ERROR', 'BŁĄD: Nie można dodać prawa użytkownika dla grupy o ID: %s');
...
<li>Jeśli instalujesz nowy moduł, pamiętaj o skonfigurowaniu preferencji modułu, bloków i uprawnień użytkowników!</li>
<li>Aby ukryć moduł w bloku menu głównego, ustaw kolejność na 0</li>
<li>Usuń nieużywane pliki modułów ze swojego serwera, aby uniknąć problemów z bezpieczeństwem i zapewnić bezpieczeństwo swojej witryny.</li>
<li>Aby zmienić kolejność modułów (co zostanie odzwierciedlone w Menu), wystarczy przeciągnąć i upuścić moduły w żądane miejsce.</li>
</ul>');
...
// 2.5.8
define('_AM_SYSTEM_MODULES_INSTALL_MORE', 'Zainstaluj więcej modułów');
// 2.5.11
define('_AM_SYSTEM_MODULES_INSTALL_THISMODULE', 'Zarządzanie modułami');
// 2.7.0
define('_AM_SYSTEM_MODULES_FK_DISABLE', 'Nie udało się wyłączyć sprawdzania klucza obcego');
define('_AM_SYSTEM_MODULES_FK_ENABLE', 'Nie udało się włączyć sprawdzania klucza obcego');
define('_AM_SYSTEM_MODULES_DROP_FAIL', 'Nie udało się usunąć tabeli: %s');
define('_AM_SYSTEM_MODULES_DROP_OK', 'Upuszczona tabela: %s');
//2.7.1
