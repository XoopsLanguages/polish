...
define('MENUS_HOME', 'Strona główna');
define('MENUS_ADMIN', 'Administracja');
define('MENUS_ACCOUNT', 'Konto');
define('MENUS_ACCOUNT_EDIT', 'Edytuj konto');
define('MENUS_ACCOUNT_LOGIN', 'Zaloguj się');
define('MENUS_ACCOUNT_LOGOUT', 'Wyloguj się');
define('MENUS_ACCOUNT_REGISTER', 'Zarejestruj się');
define('MENUS_ACCOUNT_MESSAGES', 'Wiadomości');
define('MENUS_ACCOUNT_NOTIFICATIONS', 'Powiadomienia');
define('MENUS_ACCOUNT_TOOLBAR', 'Pasek narzędzi');
